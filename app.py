...
if not filtered.empty:
    ...
    # ====================================================
    # GRÁFICO 1 — DISTRIBUIÇÃO DOS RESULTADOS
    # ====================================================
    ...
    # Mantém as cores semânticas para os resultados
    ...
    if not ecv_analysis.empty:
        ...
        # Uma cor diferente para cada ECV
        ecv_colors = [
            VISTORIAS_COLORS[
                i % len(VISTORIAS_COLORS)
            ]
